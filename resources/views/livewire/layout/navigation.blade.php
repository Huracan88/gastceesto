        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('guests') }}" wire:navigate>
                        <x-application-logo class="block h-14 object-scale-down text-gray-800" />
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('guests')" :active="request()->routeIs('guests')" wire:navigate>
                        {{ __('Registro de invitados') }}
                    </x-nav-link>
                </div>
...
{{--                        </x-dropdown-link>--}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('guests')" :active="request()->routeIs('guests')" wire:navigate>
                {{ __('Registro de invitados') }}
